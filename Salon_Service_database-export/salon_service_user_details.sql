...
CREATE TABLE `user_details` (
  ...
  PRIMARY KEY (`EmailId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Creating database for user details for salon_service';
...
INSERT INTO `user_details` VALUES ('lucky@gmail.com','123'),('test@123','test');
